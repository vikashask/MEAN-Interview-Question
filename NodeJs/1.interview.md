...
Latest version of Node.js is - v12.
...
### 51) Why to use “\_\_filename” in Node.JS?

“**filename” is used to represent the filename of the code which is being executed. It used to resolve the absolute path of file. Below is the sample code for the same –
